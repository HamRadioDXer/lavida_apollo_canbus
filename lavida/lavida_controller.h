...
#include "modules/canbus/vehicle/lavida/protocol/acc_cmd_062.h"
#include "modules/canbus/vehicle/lavida/protocol/brake_cmd_060.h"
// #include "modules/canbus/vehicle/lavida/protocol/cruise_control_buttons_cmd_108.h"
// #include "modules/canbus/vehicle/lavida/protocol/dash_controls_right_rpt_210.h"
...
#include "modules/canbus/vehicle/lavida/protocol/steer_cmd_064.h"
...
class LavidaController final : public VehicleController {
 public:
  virtual ~LavidaController();
  ...
  FRIEND_TEST(LavidaControllerTest, SetDrivingMode);
  FRIEND_TEST(LavidaControllerTest, Status);
  FRIEND_TEST(LavidaControllerTest, UpdateDrivingMode);
...
//       const ::apollo::control::ControlCommand& command) override;
 ...
 private:
  // control protocol
  Accelcmd062* accel_cmd_062_ = nullptr;
  Brakecmd060* brake_cmd_060_ = nullptr;
...
//   Parkingbrakecmd124* parking_brake_cmd_124_ = nullptr;
  Shiftcmd066* shift_cmd_066_ = nullptr;
  Steercommand064* steering_cmd_064_ = nullptr;
