...
LavidaMessageManager::LavidaMessageManager() {
  // Control Messages
  AddSendProtocolData<Accelcmd062, true>();
  AddSendProtocolData<Brakecmd060, true>();
...
//   AddSendProtocolData<Parkingbrakecmd124, true>();
  AddSendProtocolData<Shiftcmd066, true>();
  AddSendProtocolData<Steering_cmd_064, true>();
