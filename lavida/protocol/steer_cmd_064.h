...
class Steercommand064 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'physical_unit': ''}
  Steercommand064* set_steer_angle_en_ctrl(
  ...
  Steercommand064* set_steer_angle_cmd(double steer_angle_cmd);
