...
class Shiftcmd066 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Shiftcmd066* set_enable(bool enable);

  // config detail: {'name': 'CLEAR_OVERRIDE', 'offset': 0.0, 'precision': 1.0,
  // 'len': 1, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 2,
  // 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
  Shiftcmd066* set_clear_override(bool clear_override);
  ...
  Shiftcmd066* set_shift_cmd(Shift_cmd_066::Shift_cmdType shift_cmd);
 ...
 private:
  ...
  // 'offset': 0.0, 'physical_range': '[0|4]', 'bit': 15, 'type': 'enum',
  // 'order': 'motorola', 'physical_unit': ''}
  void set_p_shift_cmd(uint8_t* data, Shift_cmd_066::Shift_cmdType shift_cmd);

 private:
  bool ignore_overrides_;
  bool enable_;
  bool clear_override_;
  Shift_cmd_066::Shift_cmdType shift_cmd_ ;
};
